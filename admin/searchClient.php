        ...
        <div class="search-form-input-and-search-btn-wrapper">
          <div class="search-form-input">
            <input type="text" class="form-control" name="search"
              placeholder="Search client by ID, Name, Username, Email or Phone" maxlength="20" required />
          </div>
    ...
    <div class="search-form-list">
      <?php 
        if(isset($_POST['search'])) {
          ...
          $select_search_clients_query = "SELECT * FROM clients WHERE (`client_id` LIKE '%".$query."%') OR (`full_name` LIKE '%".$query."%') OR (`username` LIKE '%".$query."%') OR (`email` LIKE '%".$query."%') OR (`phone` LIKE '%".$query."%')";
