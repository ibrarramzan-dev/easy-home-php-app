      ...
      <div class="nano">
        <div class="nano-content">
          <ul>
            <div class="logo">
              <a href="./">
                <span>Admin-Easy Home</span>
              </a>
            </div>
            <li><a class="sidebar-sub-toggle"><i class="ti-bag"></i> Employees <span
            ...
            <li><a class="sidebar-sub-toggle"><i class="ti-panel"></i> Services <span
                  class="sidebar-collapse-icon ti-angle-down"></span></a>
              <ul>
            ...
            <li><a class="sidebar-sub-toggle"><i class="ti-panel"></i> Search <span
              ...
              <ul>
                ...
                <li><a href="./searchEmployee.php">Employee</a></li>
                <li><a href="./searchOrder.php">Order</a></li>
              </ul>
            </li>
